...
if ( etaUtente < 18 ) {
    ...
    document.getElementById("contenitore_prezzo").innerHTML = <h2>Il prezzo per il suo biglietto è  ${prezzoUnder}</h2>;
  } else if ( etaUtente > 65) {
    //istruzioni se condizione 2 è vera
    console.log(prezzoOver.toFixed(2))
    document.getElementById("contenitore_prezzo").innerHTML = <h2>Il prezzo per il suo biglietto è  ${prezzoOver}</h2>;
  } else {
    //istruzioni nessuna condizione precedente è vera
    console.log(prezzoBase.toFixed(2))
    document.getElementById("contenitore_prezzo").innerHTML = <h2>Il prezzo per il suo biglietto è  ${prezzoBase}</h2>;
  }
